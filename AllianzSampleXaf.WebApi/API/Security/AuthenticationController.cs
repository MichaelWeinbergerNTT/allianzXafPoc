...
public class AuthenticationController(IAuthenticationTokenProvider tokenProvider) : ControllerBase {
    readonly IAuthenticationTokenProvider tokenProvider = tokenProvider;
